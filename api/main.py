...
def get_connection():
    ...
    # else:
        ...
        DATABASE_URL = "postgres://omxfykfrhsxteo:161b96dcb80df2cbcac77518704fc24a3516f40a992cdd3876b9e820ab237004@ec2-52-71-217-158.compute-1.amazonaws.com:5432/d6dhdbhik40m83"
        return psycopg2.connect(DATABASE_URL, sslmode='require')
